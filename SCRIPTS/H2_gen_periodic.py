...
from DOPINGS_PACKAGE.structure import structure, atom_data
from H2_PACKAGE.h2_gen import h2_gen
from DOPINGS_PACKAGE.global_vars import dirs_data, h2_gen_data
...
for p_struct in p_structs:
    for i in range(p_struct.nH2 + 1):
        ...
        gen_H2_periodic(p_struct,
                        nH2=i,
                        output_path=dirs_data["h2_gen"]/ "periodic" / output_name,
                        vertical=True,
                        both_sides=True,
                        plot=False)
