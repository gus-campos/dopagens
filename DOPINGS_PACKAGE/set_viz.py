...
from DOPINGS_PACKAGE.global_vars import atoms_data, dirs_data
...
class set_viz:
    ...
    def gap_site_graph(set: dops_set) -> None:
        ...
        for base in set.dops_info["bases"]:
            ...
            # Nome do arquivo
            filename = dirs_data["proc_output"] / material / "gap_graphs" / "site_x_gap" / f"{base}-{dop_elem}.png"
    ...
    def gap_elem_graph(sets_list: list[dops_set]) -> None:
        ...
        for base in set.dops_info["bases"]:
            ...
            for site in set.dops_info["sites"][base]:
                ...
                # Nome do arquivo
                filename = dirs_data["proc_output"] / material / "gap_graphs" / "elem_x_gap" / f"{base}-{site}.png"
    ...
    def energ_site_graph(sets_list: list[dops_set], second_var: str=None, 
        ...
        filepath = dirs_data["proc_output"] / material / "energy_correlations" / "sites" / filename
    ...
    def energ_elem_graphs(sets_list: list[dops_set]) -> None:
        ...
        for base in sets_list[0].dops_info["bases"]:
            ...
            for site in sets_list[0].dops_info["sites"][base]:
                ...
                # Nome do arquivo
                filepath = dirs_data["proc_output"] / material / "energy_correlations" / "elems" / f"{base}-{site}.png"
