...
from global_vars import config, atoms_data, dops_data, dirs_data, main_config
...
class dops_set():
    ...
    __init__(self, dop_elem: str, dops_info: dict=None, 
                mode: str="read", param=None, force_write: bool=False
                ) -> None
    ...
    map_opt(self, only_report: bool=True, overwrite: bool=False, 
    ...
    infer_dir_out(self, struct, method, suffix=None, 
                    as_csv=False) -> Path
    ...
    def __init__(self, dop_elem: str, dops_info: dict=None, mode: str="read",
        ...
        self.main_dir = dirs_data["proc_output"]
    ...
    def infer_dops_dir(material, dop_elem, site, base) -> Path:
        ...
        return Path(dirs_data["dop_output"]).expanduser() / material / dop_elem / base / site
