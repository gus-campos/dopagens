...
from DOPINGS_PACKAGE.global_vars import dops_data, graphine_data, dirs_data
from DOPINGS_PACKAGE.graphine_calcs import graphine_calcs as gc
...
class graphine_viz:
    ...
    def geometry_graph(set: dops_set) -> None:
        ...
        for base in df_torsions["base"].unique():
            ...
            # Salvando gráfico
            dir_out = dirs_data["proc_output"] / "graphine" /  "geometry_graphs" /  f"{set.dop_elem}-{base}.png"
